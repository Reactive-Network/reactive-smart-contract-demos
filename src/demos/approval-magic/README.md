...
> **Important**: Do not send more than 10 SepETH per request. Sending over 10 SepETH will cause you to lose the excess amount without receiving any additional REACT. The maximum you should send in a single transaction is 10 SepETH, which will yield 50 REACT.
